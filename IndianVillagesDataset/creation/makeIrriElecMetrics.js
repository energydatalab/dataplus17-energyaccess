...
var all_final = greenestCloudfreeComposite.addBands(ndvi_final).addBands(green_final).addBands(rain_final).addBands(viirs)

// print final information
print(all_final,'48 bands information')

// Export data to drive
Export.image.toDrive({
    image: all_final,
    description: 'final_48',
    scale: 30,
    region: roi,
    maxPixels: 1E13
});
